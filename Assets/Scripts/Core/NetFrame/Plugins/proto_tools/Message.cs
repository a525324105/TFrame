...
namespace pb {
    ...
    static Message() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "EgoKAmlkGAEgASgEEgsKA3BybxgCIAEoBSJNCgxDMlNfSW5wdXRNc2cSCwoD", 
            "c2lkGAEgASgFEgkKAXgYAiABKAISCQoBeRgDIAEoAhIJCgF6GAQgASgCEg8K", 
            "B2ZyYW1lSUQYBSABKA0iWQoJSW5wdXREYXRhEgoKAmlkGAEgASgEEgsKA3Np", 
            "ZBgCIAEoBRIJCgF4GAMgASgCEgkKAXkYBCABKAISCQoBehgFIAEoAhISCgpy", 
            "b29tc2VhdGlkGAYgASgFIjoKCUZyYW1lRGF0YRIPCgdmcmFtZUlEGAEgASgN", 
            "EhwKBWlucHV0GAIgAygLMg0ucGIuSW5wdXREYXRhIi0KDFMyQ19GcmFtZU1z", 
            "ZxIdCgZmcmFtZXMYASADKAsyDS5wYi5GcmFtZURhdGEiIQoNQzJTX1Jlc3Vs", 
            "dE1zZxIQCgh3aW5uZXJJRBgBIAEoBCrEAQoCSUQSDQoJTVNHX0JFR0lOEAAS", 
            "DwoLTVNHX0Nvbm5lY3QQARIRCg1NU0dfSGVhcnRiZWF0EAISEAoMTVNHX0pv", 
            "aW5Sb29tEAoSEAoMTVNHX1Byb2dyZXNzEBQSDQoJTVNHX1JlYWR5EB4SDQoJ", 
            "TVNHX1N0YXJ0ECgSDQoJTVNHX0ZyYW1lEDISDQoJTVNHX0lucHV0EDwSDgoK", 
            "TVNHX1Jlc3VsdBBGEg0KCU1TR19DbG9zZRBkEgwKB01TR19FTkQQ/wEqWwoJ", 
            "RVJST1JDT0RFEgoKBkVSUl9PaxAAEhAKDEVSUl9Ob1BsYXllchABEg4KCkVS", 
          "Ul9Ob1Jvb20QAhIRCg1FUlJfUm9vbVN0YXRlEAMSDQoJRVJSX1Rva2VuEAQ="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_pb_InputData__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::pb.InputData, global::pb.InputData.Builder>(internal__static_pb_InputData__Descriptor,
                new string[] { "Id", "Sid", "X", "Y", "Z", "Roomseatid", });
  ...
  public sealed partial class C2S_InputMsg : pb::GeneratedMessage<C2S_InputMsg, C2S_InputMsg.Builder> {
    ...
    private static readonly string[] _c2SInputMsgFieldNames = new string[] { "frameID", "sid", "x", "y", "z" };
    private static readonly uint[] _c2SInputMsgFieldTags = new uint[] { 40, 8, 21, 29, 37 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasFrameID) {
        output.WriteUInt32(5, field_names[0], FrameID);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasFrameID) {
        size += pb::CodedOutputStream.ComputeUInt32Size(5, FrameID);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
  ...
  public sealed partial class InputData : pb::GeneratedMessage<InputData, InputData.Builder> {
    ...
    private static readonly string[] _inputDataFieldNames = new string[] { "id", "roomseatid", "sid", "x", "y", "z" };
    private static readonly uint[] _inputDataFieldTags = new uint[] { 8, 48, 16, 29, 37, 45 };
    ...
    public const int RoomseatidFieldNumber = 6;
    private bool hasRoomseatid;
    private int roomseatid_;
    public bool HasRoomseatid {
      get { return hasRoomseatid; }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasX) {
        output.WriteFloat(3, field_names[3], X);
      }
      if (hasY) {
        output.WriteFloat(4, field_names[4], Y);
      }
      if (hasZ) {
        output.WriteFloat(5, field_names[5], Z);
      }
      if (hasRoomseatid) {
        output.WriteInt32(6, field_names[1], Roomseatid);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasZ) {
        size += pb::CodedOutputStream.ComputeFloatSize(5, Z);
      }
      if (hasRoomseatid) {
        size += pb::CodedOutputStream.ComputeInt32Size(6, Roomseatid);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
