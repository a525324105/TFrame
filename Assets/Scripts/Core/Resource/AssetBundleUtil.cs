...
public static class AssetBundleUtil
{
    ...
    public static bool WriteToFile(string dirOut, string fileName, byte[] data)
    {
        try
        {
            ...
            fileStream.Flush();
            fileStream.Close();
            Debug.LogErrorFormat("write asset[{0}] ok", (object)fileName);
            return true;
        }
        catch (Exception ex)
        {
            Debug.LogErrorFormat("write asset[{0}] failed, error[{1}]", (object)fileName, (object)ex.ToString());
            return false;
        }
    }
    ...
    public static string GetFileMd5(string path)
    {
        ...
        Debug.LogErrorFormat("GetFileMd5 failed, Read file failed: {0}", (object)path);
        return (string)null;
    }
    ...
    public static bool IsFileExist(string path)
    {
        ...
        {
            Debug.LogErrorFormat("Check exist exception: {0}", (object)ex.ToString());
        }
        return false;
    }
    ...
    public static int ReadFileLen(string path)
    {
        ...
        {
            Debug.LogErrorFormat("ReadFileLen failed:{0}, error:{1}", (object)path, (object)ex.ToString());
        }
        return 0;
    }
    ...
    public static byte[] ReadFile(string path)
    {
        ...
        if (!string.IsNullOrEmpty(errInfo))
            Debug.LogErrorFormat("ReadFile failed: {0}", (object)errInfo);
        return numArray;
    }
    ...
    public static T ReadJsonKey<T>(Dictionary<string, object> json, string key)
    {
        if (json.ContainsKey(key))
        {
            ...
            {
                Debug.LogErrorFormat("key: {0} convert type {1} to {2} failed, exception:{3}", (object)key, (object)json[key].GetType(), (object)typeof(T).ToString(), (object)ex.ToString());
            }
        }
        return default(T);
    }
    ...
    public static List<object> ReadJsonList(string url, string content, ref string error)
    {
        ...
        try
        {
            ...
            if (objectList == null)
            {
                ...
                Debug.LogErrorFormat("parse md5 file failed !!!");
        ...
        catch (Exception ex)
        {
            ...
            Debug.LogErrorFormat("parse md5 root file failed[{0}] Content[{1}] Exception[{2}]", (object)url, (object)content, (object)ex.ToString());
            return (List<object>)null;
        }
        return objectList;
    }
    ...
    public static AssetRootMetaInfo ParseRootMeta(string content)
    {
        ...
        if (json != null)
        {
            ...
            Debug.LogErrorFormat("parse md5 file failed[{0}] Content[{1}]", (object)"root.byte", (object)content);
...
public class XFileUtil
{
    ...
    public static bool CreateDir(string dir)
    {
        ...
        {
            Debug.LogErrorFormat("create dir[{0}] failed, error[{1}]", (object)dir, (object)ex.ToString());
            return false;
        }
    }
    ...
    public static void DeleteFile(string path)
    {
        ...
        {
            Debug.LogErrorFormat("DeleteFile [{0}] failed, error[{1}]", (object)path, (object)ex.ToString());
        }
    }
    ...
    public static bool DeleteDir(string dir)
    {
        ...
        {
            Debug.LogErrorFormat("DeleteDir dir[{0}] failed, error[{1}]", (object)dir, (object)ex.ToString());
            return false;
        }
    }
}
